function insert(){
    ...
    //This "for" loop will check for the checkbox condition
    for(i=0;i<5;i++)
    {
        if(food[i].checked === false )
        {
            count++;
            if(count > 3)
            {
                alert("Must choose at least 2 food options out of 5");
                return false;
            }
            else
            {
    ...
    //The below function will insert the data into the table
